...
function SC_G.ResetCurrentObjectiveStreaks()
   resourceStreak, keepStreak = 0, 0
end
...
function SC_G.KeepOwnerChanged(_, keepId, bgContext, newOwner, oldOwner)
   local myLocation, keepName = (GetPlayerLocationName()), (GetKeepName(keepId))
...
--[[
   ...
   |-----------------------+--------------------------------------------------------------|
--]]
function SC_G.ObjectiveControlState(eventId, objectiveKeepId, objectiveObjectiveId, battlegroundContext, objectiveName, objectiveType, objectiveControlEvent, objectiveControlState, objectiveParam1, objectiveParam2)
